...
public class CreateRTP {
	...
	@JacksonXmlProperty(localName = "RequestInfo")
	private RequestInfo requestInfo;
	public CreateRTP() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CreateRTP(String xmlns, Head head, Req req, ChannelInfo channelInfo, RequestInfo requestInfo) {
		super();
		this.xmlns = xmlns;
		this.head = head;
		this.req = req;
